...
class Clean:
    ...
    class Config:
        def __init__(
            ...
            self.fields = None;
            self.filter_na_cols = False;
            self.filter_na_rows = False;
            self.replace_na_blank = False;
            self.replace_na_zero = False;
            self.trim_whitespace = False;
            self.remove_dup_space = False;
            self.remove_all_space = False;

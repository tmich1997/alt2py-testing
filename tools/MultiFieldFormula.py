...
class MultiFieldFormula:
    ...
    def execute(self,input_datasource):
        ...
        for f in c.fields:
            ...
            tool.add_formula(field=c.prefix +f+c.suffix,expression=Functions.format_field_formula(c.expression,f),type=c.change_type,size=c.size)
